      ...
      <div class="col-md-9">
        ...
        <div class="container">
          <div class="contact-us-content mt-3">
            <div class="font-weight-bold">JRN Rajasthan Vidyapeeth University</div>
            <div class="clearfix">
            </div>
            <div class="address">Pratap Nagar, Udaipur (313001)</div>
            <div class="clearfix">
            </div>
            <div class="address">Rajasthan, India</div>
            <div class="clearfix">
            </div>
            <div class="phone-no">Phone: 0294-2494217 / 2494227</div>
            <div class="clearfix">
            </div>
            <div class="email-address">Email: dcsit.jrnrvu@gmail.com</div>
            <hr>
            <hr>
